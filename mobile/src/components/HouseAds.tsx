...
/** Placeholder store URLs — swap for production domains. */
export const HOUSE_AD_URLS = {
  mainstreetTees: 'https://example.com/mainstreet-tees',
} as const;
...
export function buildPlaylistDetailFlashRows(
  ...
  const base: PlaylistDetailListItem[] = tracks.map((t) => ({ type: 'track', track: t }));
