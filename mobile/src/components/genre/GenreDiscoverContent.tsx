...
import { ChevronLeft, Music, Play, Radio } from 'lucide-react-native';
    ...
    >
      ...
      <View style={styles.section}>
        <View style={styles.sectionHead}>
          ...
          <Text style={styles.sectionTitle}>Vybe Music</Text>
        </View>
      ...
      <View style={styles.section}>
        <View style={styles.sectionHead}>
          <View style={styles.badgeRedWide}>
            <Play size={11} color="#fff" fill="#fff" />
          </View>
          <Text style={styles.sectionTitle}>Vybe Video</Text>
        </View>
      ...
      <View style={styles.section}>
        <View style={styles.sectionHead}>
          ...
          <Text style={styles.sectionTitle}>Vybe Waves</Text>
        </View>
