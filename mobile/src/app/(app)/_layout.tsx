...
import { View, StyleSheet, AppState, Linking, Text, Pressable, ActivityIndicator } from 'react-native';
...
export default function AppLayout() {
  ...
  const isTabPath =
    ...
    pathNorm === '/index' ||
    pathNorm === '/(app)/(tabs)' ||
    pathNorm === '/(app)/(tabs)/index' ||
    pathNorm === '/(app)/(tabs)/search' ||
    pathNorm === '/(app)/(tabs)/library' ||
    pathNorm === '/(app)/(tabs)/discover' ||
    pathNorm === '/(app)/(tabs)/profile' ||
    pathNorm === '/(app)/(tabs)/social' ||
    pathNorm === '/search' ||
    pathNorm === '/library' ||
    pathNorm === '/discover' ||
    pathNorm === '/profile' ||
