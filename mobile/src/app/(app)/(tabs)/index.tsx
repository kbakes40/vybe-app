  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#000000' }}>
      ...
      >
        ...
        <View style={{ paddingTop: insets.top + 24, backgroundColor: '#000000', alignItems: 'center' }}>
          <VybeHeaderMark size={36} />
          <Animated.View style={[{ paddingHorizontal: 20, paddingBottom: 12, paddingTop: 16, alignSelf: 'stretch' }, greetingAnimatedStyle]}>
            <Text style={{ color: '#fff', fontSize: 30, fontWeight: '800', letterSpacing: -0.5 }}>
              {headline}
            </Text>
            <Text style={{ color: 'rgba(253,230,138,0.45)', fontSize: 13, fontWeight: '600', marginTop: 8, letterSpacing: 0.4 }}>
