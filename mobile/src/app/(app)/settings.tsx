...
> = {
  account: { color: '#FFFFFF', glow: 'rgba(255,255,255,0.55)' },
  audio: { color: '#22D3EE', glow: '#22D3EE' },
  data: { color: '#A78BFA', glow: '#A78BFA' },
  notifications: { color: '#FBBF24', glow: '#FBBF24' },
  privacy: { color: '#FF00FF', glow: '#FF00FF' },
  content: { color: '#E2E8F0', glow: 'rgba(226,232,240,0.5)' },
  storage: { color: '#94A3B8', glow: '#94A3B8' },
  discovery: { color: '#C084FC', glow: '#C084FC' },
  about: { color: '#64748B', glow: '#64748B' },
  developer: { color: '#8B5CF6', glow: '#8B5CF6' },
    ...
    >
      ...
      {showSwitch ? (
        <Switch
          ...
          trackColor={{ false: '#111111', true: '#FF00FF' }}
          thumbColor="#FFFFFF"
