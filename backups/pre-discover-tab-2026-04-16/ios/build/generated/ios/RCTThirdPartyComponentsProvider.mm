...
+ (NSDictionary<NSString *, Class<RCTComponentViewProtocol>> *)thirdPartyFabricComponents
{
  ...
  dispatch_once(&nativeComponentsToken, ^{
    thirdPartyComponents = @{
			...
			@"RNCTabView": NSClassFromString(@"RCTTabViewComponentView"), // react-native-bottom-tabs
			@"EnrichedTextInputView": NSClassFromString(@"EnrichedTextInputView"), // react-native-enriched
